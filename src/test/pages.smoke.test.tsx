...
import AuthAccountRecoveryHelpComp from '../pages/auth/AccountRecoveryHelp'
import AuthChooseAccountComp from '../pages/auth/ChooseAccount'
import AuthConsentComp from '../pages/auth/Consent'
import AuthContinueComp from '../pages/auth/Continue'
import AuthErrorComp from '../pages/auth/Error'
import AuthForgotPasswordComp from '../pages/auth/ForgotPassword'
import AuthMfaComp from '../pages/auth/Mfa'
import AuthPasskeyComp from '../pages/auth/Passkey'
import AuthReAuthComp from '../pages/auth/ReAuth'
import AuthRecoveryCodeComp from '../pages/auth/RecoveryCode'
import AuthResetPasswordComp from '../pages/auth/ResetPassword'
import AuthSetPasswordComp from '../pages/auth/SetPassword'
import AuthSignInComp from '../pages/auth/SignIn'
import AuthSignInOtpComp from '../pages/auth/SignInOtp'
import AuthSignUpComp from '../pages/auth/SignUp'
import AuthSignedOutComp from '../pages/auth/SignedOut'
import AuthVerifyEmailComp from '../pages/auth/VerifyEmail'
import AuthVerifyPhoneComp from '../pages/auth/VerifyPhone'
