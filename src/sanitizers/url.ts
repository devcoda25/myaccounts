...
export function isValidUrl(url: string): boolean {
    try {
        ...
        const isEvzoneMarket = hostname === 'evzonemarketplace.com' || hostname.endsWith('.evzonemarketplace.com');

        return isEvzone || isEvzoneApp || isEvzoneMarket;
    } catch {
        return false;
    }
}
...
export function sanitizeUrl(url: string): string {
    ...
    try {
        ...
        const isEvzone = hostname === 'evzone.com' || hostname.endsWith('.evzone.com') ||
                         ...
                         hostname === 'evzonemarketplace.com' || hostname.endsWith('.evzonemarketplace.com');
