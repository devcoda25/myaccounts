...
export function sanitizeUrl(url: string): string {
    ...
    try {
        ...
        const prodDomains = ['evzone.com', 'evzone.app', 'evzonemarketplace.com'];
        const isProdDomain = prodDomains.some(domain => parsed.hostname === domain || parsed.hostname.endsWith('.' + domain));
