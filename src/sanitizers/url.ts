...
export function isValidUrl(url: string): boolean {
    try {
        ...
        const isEvzoneCom = host === 'evzone.com' || host.endsWith('.evzone.com');
        const isEvzoneApp = host === 'evzone.app' || host.endsWith('.evzone.app');
...
export function sanitizeUrl(url: string): string {
    ...
    try {
        ...
        const host = parsed.hostname;
        const isEvzone = host === 'evzone.com' || host.endsWith('.evzone.com') || host === 'evzone.app' || host.endsWith('.evzone.app');
