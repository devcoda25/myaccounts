...
export default function ReAuthPromptPage() {
  ...
  const continueNext = () => {
    setSnack({ open: true, severity: "info", msg: "Continue → execute the sensitive action (demo)." });
  };
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={2}>
              ...
              <Stack direction="row" spacing={1} alignItems="center">
                ...
                <Tooltip title="Help">
                  <IconButton
                    size="small"
                    onClick={() => setSnack({ open: true, severity: "info", msg: "Re-auth help (demo)" })}
                    sx={{ border: `1px solid ${alpha(EVZONE.orange, 0.35)}`, borderRadius: 12, backgroundColor: alpha(theme.palette.background.paper, 0.6), color: EVZONE.orange }}
                  >
                ...
                <CardContent className="p-5 md:p-7">
                  {step === "success" ? (
                    ...
                    <Stack spacing={2.0}>
                      ...
                      {promptMode === "password" ? (
                        <Stack spacing={1.4}>
                          ...
                          <Stack direction={{ xs: "column", sm: "row" }} spacing={1.2}>
                            ...
                            <Button variant="outlined" sx={orangeOutlinedSx} onClick={() => setSnack({ open: true, severity: "info", msg: "Forgot password flow (demo)" })}>
                              Forgot password
                            </Button>
                          </Stack>
                        </Stack>
                      ...
                      <Button variant="text" sx={orangeTextSx} onClick={() => setSnack({ open: true, severity: "info", msg: "Cancel (demo)" })}>
                        Cancel
                      </Button>
                    </Stack>
                  )}
