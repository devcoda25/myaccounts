...
export default function CookiePolicyPage() {
  ...
  const sections = useMemo(
    () => [
      ...
      { id: "types", title: "2. Types of cookies" },
      { id: "manage", title: "3. Managing cookies" },
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={2}>
              <Stack direction="row" spacing={1.2} alignItems="center">
                ...
                <Box>
                  ...
                  <Typography variant="caption" sx={{ color: theme.palette.text.secondary }}>Cookie Policy</Typography>
                </Box>
              </Stack>
              ...
              <CardContent className="p-5 md:p-7">
                <Stack spacing={1.2}>
                  ...
                  <Typography variant="body2" sx={{ color: theme.palette.text.secondary }}>
                    This page is a template. Replace with your final cookie policy.
                  </Typography>
                  ...
                  <CardContent className="p-5 md:p-7">
                    <Stack spacing={2.2}>
                      <Section id="overview" title="1. Overview">
                        Cookies help EVzone provide secure login sessions, improve performance, and understand usage.
                      </Section>

                      <Section id="types" title="2. Types of cookies">
                        Examples:
                        - Essential cookies: required for authentication and security.
                        - Preference cookies: language and appearance.
                        - Analytics cookies: usage metrics.
                        - Marketing cookies: advertising and campaign attribution.
                      </Section>

                      <Section id="manage" title="3. Managing cookies">
                        Users can adjust browser settings, clear cookies, or use cookie preference controls where available.
                        Disabling essential cookies may prevent sign-in.
                      </Section>

                      <Section id="third" title="4. Third-party cookies">
                        Some features may use third-party services (analytics, payments). Their cookies are governed by their own policies.
                      </Section>

                      <Section id="contact" title="5. Contact">
                        Contact EVzone support through the My Accounts support center.
                      </Section>
