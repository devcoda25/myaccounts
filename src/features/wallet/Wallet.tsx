...
import { ExternalLink as LinkIcon, Wallet as WalletIcon } from "lucide-react";
        ...
        <Card sx={{ maxWidth: 480, width: "100%", borderRadius: 4, textAlign: "center", border: `1px solid ${alpha(theme.palette.text.primary, 0.1)}` }}>
          <CardContent sx={{ p: 6 }}>
            ...
            <Typography variant="body1" sx={{ color: "text.secondary", mb: 4 }}>
              The Wallet has moved to its own dedicated secure application. Access your funds and transaction history there.
            </Typography>
            <Button
              variant="contained"
              size="large"
              href="https://wallet.evzone.app" // Placeholder URL
              target="_blank"
