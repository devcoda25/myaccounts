...
const AuthAccountRecoveryHelp = lazy(() => import('../pages/auth/AccountRecoveryHelp'))
const AuthChooseAccount = lazy(() => import('../pages/auth/ChooseAccount'))
const AuthConsent = lazy(() => import('../pages/auth/Consent'))
const AuthContinue = lazy(() => import('../pages/auth/Continue'))
const AuthError = lazy(() => import('../pages/auth/Error'))
const AuthForgotPassword = lazy(() => import('../pages/auth/ForgotPassword'))
const AuthMfa = lazy(() => import('../pages/auth/Mfa'))
const NotFound = React.lazy(() => import('../pages/errors/NotFound'));
const AdminRouter = React.lazy(() => import('./AdminRouter'));
const AdminLogin = React.lazy(() => import('../pages/auth/AdminLogin'));
const AuthPasskey = lazy(() => import('../pages/auth/Passkey'))
const AuthReAuth = lazy(() => import('../pages/auth/ReAuth'))
const AuthRecoveryCode = lazy(() => import('../pages/auth/RecoveryCode'))
const AuthResetPassword = lazy(() => import('../pages/auth/ResetPassword'))
const AuthSetPassword = lazy(() => import('../pages/auth/SetPassword'))
const AuthSignIn = lazy(() => import('../pages/auth/SignIn'))
const AuthSignInOtp = lazy(() => import('../pages/auth/SignInOtp'))
const AuthSignUp = lazy(() => import('../pages/auth/SignUp'))
const AuthSignedOut = lazy(() => import('../pages/auth/SignedOut'))
const AuthVerifyEmail = lazy(() => import('../pages/auth/VerifyEmail'))
const AuthVerifyPhone = lazy(() => import('../pages/auth/VerifyPhone'))
